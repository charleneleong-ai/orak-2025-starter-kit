...
class CheckpointManager:
    ...
    def save_agent_checkpoint(
        ...
        if not isinstance(agent, Checkpointable):
            raise TypeError(f"Agent must implement Checkpointable protocol (have get_state, load_state, get_checkpoint_metadata methods)")
    ...
    def list_checkpoints(self, game_name: Optional[str] = None, agent_name: Optional[str] = None) -> list[Dict[str, Any]]:
        """
