...
| Lever | Status | Notes |
|---|---|---|
| **Stage K — cumulative cross-episode memory** | ✅ Merged 2026-05-15 ([PR #75](https://github.com/charleneleong-ai/orak-2025-starter-kit/pull/75), commit [`90dfccc`](https://github.com/charleneleong-ai/orak-2025-starter-kit/commit/90dfccc)) | Final: `[57.14] × 5`, σ=0.00pp, `learning_delta=+0.00pp` — floor-stable but no compounding. Introspection showed negative transfer (iter 2 took +91 steps to bank M4). Asm fix prevents catastrophic floor regression but doesn't fix context-blind procedure keying. Motivated the Stage L redesign. |
...
**PR 1 in flight — universal futile-action detector** (branch `feat/futile-action-detector` @ [`176f68c`](https://github.com/charleneleong-ai/orak-2025-starter-kit/commit/176f68c)):
