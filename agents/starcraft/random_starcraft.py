...
PROTOSS_ACTIONS = [
    ...
    "RESEARCH BLINKTECH", "RESEARCH CHARGE", "RESEARCH PROTOSSGROUNDWEAPONSLEVEL1",
    "RESEARCH PROTOSSGROUNDWEAPONSLEVEL2", "RESEARCH PROTOSSGROUNDWEAPONSLEVEL3",
    "RESEARCH PROTOSSGROUNDARMORSLEVEL1", "RESEARCH PROTOSSGROUNDARMORSLEVEL2",
    "RESEARCH PROTOSSGROUNDARMORSLEVEL3", "RESEARCH PROTOSSSHIELDSLEVEL1",
    "RESEARCH PROTOSSSHIELDSLEVEL2", "RESEARCH PROTOSSSHIELDSLEVEL3",
